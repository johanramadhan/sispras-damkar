      ...
      <div class="d-flex" id="wrapper" data-aos="fade-right">
        ...
        <div class="border-right" id="sidebar-wrapper">
          <div class="sidebar-heading text-center">
            <img src="/images/logo-sidebar.png" alt="" class="my-4" />
          </div>
          <div class="list-group list-group-flush">
            ...
            <a
              ...
              class="list-group-item list-group-item-action {{ (request()->is('dashboard/proposal*')) ? 'active' : '' }}"
            >
              Pengajuan Barang
            </a>
            {{-- <a
            ...
            <a
              href="{{ route('dashboard-settings-sispras') }}"
